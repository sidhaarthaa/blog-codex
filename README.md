...
A minimalist blog built with **Next.js 14 + Markdown content**, now styled with a black-and-white brutalist aesthetic.
...
- Dark mode toggle (strict black/white palette)
- RSS feed at `/rss.xml`
